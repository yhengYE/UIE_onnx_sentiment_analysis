...
import wordcloud
from Uutils import load_json_file
...
class VisualSentiment(object):
    ...
    def _plot_content_with_frequency(
        ...
        two types of hotel_images are supported: wordcloud and histogram.
    ...
    def plot_aspect_with_frequency(
        ...
        """
        generate image for aspect, two types of hotel_images are supported: wordcloud and histogram.
    ...
    def plot_opinion_with_frequency(
        ...
        """
        generate image for opinion, two types of hotel_images are supported: wordcloud and histogram.
    ...
    def parse_sentiment_result(self, results):
        ...
        for prompt in self.prompts:
            if prompt.startswith(self.sentiment_prompt_prefix) and prompt != self.sentiment_prompt:
                logger.warning(
                    "The visual hotel_images related to sentiment ploarity cannot be generated. Because the sentiment prompt {} created by the opinions you input cannot be match with the one {} in the file of sentiment analysis result.".format(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_path", default='',required=False, type=str, help="The result path of sentiment analysis.")
